...
- **音频/玩法扩展**：擦弹粒子 `GrazeSpark`、符卡冷却随擦弹缩减（GDD）；主菜单与 BGM 持久化策略若需对齐 Godot 再迭代。
